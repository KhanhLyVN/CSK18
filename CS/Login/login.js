...
function debugFirebase() {
    ...
    try {
        ...
        if (!isFirebaseReady()) {
            ...
            console.error(
                "firebase-config.js chưa initialize Firebase."
            );
        ...
        if (
            ...
            console.error(
                "CẢNH BÁO: Project Firebase không phải faq-csk18."
            );
        ...
        async function () {
            ...
            try {
                ...
                if (!account) {
                    ...
                    console.error(
                        "Không tìm thấy profile Firestore."
                    );
                ...
                if (
                    ...
                    toast(
                        "Email Google không khớp với tài khoản trong hệ thống.",
                        "error"
                    );
