...
(function () {
  ...
  function setupEvents() {
    ...
    elements.addAccountBtn?.addEventListener(
      "click",
      () => {
        ...
        db
          ...
          .onSnapshot(
            ...
            error => {
              ...
              showTableError(
                "Không thể tải tài khoản từ Firestore."
              );
  ...
  function updateStatistics() {
    ...
    setText(
      elements.activeMeta,
      `${active}/${total} tài khoản đang hoạt động`
    );
